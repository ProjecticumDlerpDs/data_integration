...
In deze Rmarkdown wordt de data van tijdspunt E7.5 gebruikt. De data is afkomstig van muizenembryo's. 
...
VizDimLoadings(e75, dims = 1:2, reduction = "pca")
```
...
e75 <- FindClusters(e75, resolution = 0.3)
head(Idents(e75), 5)
```
...
```{r Clusterbiomarkers Figure 9, fig.cap="ViolinPlot: Het expressielevel van het gen Tenm3_intron wordt per cluster weergegeven. In cluster 3 komt dit gen het meest tot expressie."}
